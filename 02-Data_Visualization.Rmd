...
```{r setup, warning = FALSE, tidy = TRUE, message = FALSE, results = FALSE}
# Clear Environment -----------------------------------------------------------
rm(list = ls())
...
```{r Visulization, tidy = TRUE, fig.height = 20, fig.width = 12}
ggplot(data = gather(., factor_key = TRUE), aes(x = factor(value))) + 
  geom_bar() + 
