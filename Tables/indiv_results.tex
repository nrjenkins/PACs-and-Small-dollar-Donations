...
\setlength{\linewidth}{.1cm}\newcommand{\contents}{\begin{tabular}{@{\extracolsep{5pt}}l c c c c c c }
 \\[-1.8ex] \toprule  \\[-1.8ex]
 & \multicolumn{6}{c}{\textbf{Outcome Variable:}} \\
\textbf{Predictor Variables} & Small-dollar \$ & Large-dollar \$ & Total Individual \$ & Ideological Individual \$ & Business Individual \$ & Labor Individual \$\\
 \midrule  \\[-1.8ex]
