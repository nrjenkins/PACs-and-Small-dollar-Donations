...
indiv.models <- c(laborindv.fit, individeopac.fit, bizindv.fit, smlindv.fit, 
                  lrgindv.fit, totindv.fit)
names(indiv.models) <- c("laborindv.fit", "individeopac.fit", "bizindv.fit", 
                         "smlindv.fit", "lrgindv.fit", "totindv.fit")
post.indiv <- 
  indiv.models %>%
  map_dfr(~ spread_draws(., a, b_np, p, p_np), .id = "model")
